...
describe('POST /api/v1/accounts/register-owner', () => {
  ...
  it('should signup a user ', async () => {
    ...
    expect(res.body.message).toEqual('Registration successfull, please check your email for verification instructions');
...
describe('PUT/GET /api/v1/accounts/:id fetch account by id', () => {
  ...
  it('Should not update the account of the admin', async () => {
    ...
    expect(res.body.message).toEqual('Email sunday@owner.com is already taken');
  });
